...
const REQUIRED = [
  ...
  'plugin/d2d-panel/lib/client/tab-registry.js', 'plugin/d2d-panel/lib/client/view.ops.js',
  'plugin/d2d-panel/lib/client/cards.ops.js', 'plugin/d2d-panel/scripts/build-client.mjs',
  'plugin/d2d-panel/lib/host/snapshot.mjs',
  ...
  'scripts/ops/cleanup-main.mjs', 'scripts/ops/verify-main.mjs', 'scripts/ops/backup-graph.sh', 'scripts/ops/model-rotate.mjs',
  ...
  '.github/workflows/gates.yml', '.github/CODEOWNERS', '.github/dependabot.yml',
]
let miss = 0
